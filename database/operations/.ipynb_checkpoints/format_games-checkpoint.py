...
async def format_games(games, player_name):
    ...
    print('$$$$$$$$$$$$$$$$$$$$$$')
    print('unique_player done in: ',(time.time()-start_get_unique_players))
    print('unique players ', len(unique_player_names))
    print('$$$$$$$$$$$$$$$$$$$$$$')
    ...
    if not unique_player_names:
        ...
        print('$$$$$$$$$')
        unique_player_names = await get_only_players_not_in_db(unique_player_names)
